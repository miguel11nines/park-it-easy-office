-- Final fix for durations_overlap function search_path issue
-- Drop all versions of the function and recreate with proper settings

-- Drop any existing versions
DROP FUNCTION IF EXISTS public.durations_overlap(booking_duration, booking_duration) CASCADE;

-- Recreate with immutable search_path set to empty string
...
-- Recreate the trigger function that uses durations_overlap
